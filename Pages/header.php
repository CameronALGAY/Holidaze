    ...
    <div class="navbar-container d-flex align-items-center justify-content-between w-100">
        ...
        <div class="d-flex align-items-center">
            <ul class="navbar-nav me-3">
                ...
                <!-- Nouvel onglet Contact (visible seulement si connecté) -->
                <?php if (isset($_SESSION['utilisateur_id'])): ?>
                    ...
                    <div class="profile-dropdown">
                        <div id="profileToggle">
                            <?php if (!empty($_SESSION['photo_profil'])): ?>
                                <img src="<?= htmlspecialchars($_SESSION['photo_profil']) ?>" 
                                     alt="Photo de profil" 
                                     class="profile-pic"
                        ...
                        <div id="profileDropdownMenu" class="profile-dropdown-menu">
                            <div class="dropdown-header">
                                <p class="dropdown-header-name">
                                    <?= htmlspecialchars($_SESSION['prenom'] . ' ' . $_SESSION['nom']) ?>
                                </p>
                                <?php if (!empty($_SESSION['email'])): ?>
                                    <p class="dropdown-header-email"><?= htmlspecialchars($_SESSION['email']) ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <?php if (!empty($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                                <a href="/Pages/admin_dashboard.php" class="dropdown-item-custom">
                            ...
                            <a href="/Pages/Formulaires/deconnexion.php" class="dropdown-item-custom dropdown-logout">
            ...
            <?php else: ?>
                ...
                <a href="/Pages/Formulaires/inscription.php" class="btn btn-outline-primary btn-sm me-3">Inscription</a>
            <?php endif; ?>
        </div>
    </div>
</nav>
